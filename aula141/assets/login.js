class Login {
    ...
    static login = (callback_ok, callback_naook, config) => {
        ...
        ".campoLogin input {font-size: 18px;padding: 5px;background-color: #fff;border-radius: 5px;width: 150%;}"+
        ".botoesLogin {display: flex;justify-content: space-around;align-items: flex-start;width: 100%;}" +
